...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description:
      "Get in touch with Open Mortgage for all your mortgage and loan needs",
    ...
    <Section title="Contact Us" className="bg-gray-50 py-16">
      <div className="max-w-4xl mx-auto">
        <p className="text-lg text-[#666666] mb-8 text-center">
          Have questions or ready to get started? We&apos;re here to help. Fill
          out the form below or contact us directly.
        </p>
