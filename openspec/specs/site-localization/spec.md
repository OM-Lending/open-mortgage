...
## Purpose
Define how the site delivers a consistent bilingual (English and Chinese) experience across marketing, services, resources, blogs, navigation, and SEO metadata, using aligned translation messages and locale-aware routing.
## Requirements
